...
# Путь к файлу Excel
file_path = 'C:\\Users\\User\\Downloads\\BLM_OR_Aerial_Photography_Footprint_Polygon_Hub_-6846772482212028591.xlsx'

# Чтение данных из файла Excel
data = pd.read_excel(file_path)

# Используем столбец 'Shape__Area' как сигнал
signal_values = data['Shape__Area'].values  # Значения сигнала
