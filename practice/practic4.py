...
# Путь к файлу
file_path = 'C:\\Users\\User\\Desktop\\BLM_OR_Aerial_Photography_Flightlines_Line_Hub_-4184966785027956367.xlsx'

# Загрузка данных из файла
data = pd.read_excel(file_path)  # Читаем файл без заголовка

# Преобразуем данные в одномерный массив
signal_values = data['Shape__Length'].values  # Берем первую строку и преобразуем в массив
